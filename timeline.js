...
var TL = function(t) {
    ...
    class pt {
        ...
        _onDragStart(t) {
            x ? t.originalEvent ? (this.data.pagex.start = t.originalEvent.touches[0].screenX, this.data.pagey.start = t.originalEvent.touches[0].screenY) : (this.data.pagex.start = t.targetTouches[0].screenX, this.data.pagey.start = t.targetTouches[0].screenY) : (this.data.pagex.start = t.pageX, this.data.pagey.start = t.pageY), this.options.enable.x && (this._el.move.style.left = this.data.pagex.start - this._el.move.offsetWidth / 2 + "px"), this.options.enable.y && (this._el.move.style.top = this.data.pagey.start - this._el.move.offsetHeight / 2 + "px"), this.data.pos.start = E(this._el.drag), this.data.time.start = (new Date).getTime(), this.fire("dragstart", this.data), mt.addListener(this._el.drag, this.dragevent.move, this._onDragMove, this), mt.addListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this)
        }
        _onDragEnd(t) {
        ...
        _onDragMove(t) {
            t.preventDefault(), this.data.sliding = !0, x ? t.originalEvent ? (this.data.pagex.end = t.originalEvent.touches[0].screenX, this.data.pagey.end = t.originalEvent.touches[0].screenY) : (this.data.pagex.end = t.targetTouches[0].screenX, this.data.pagey.end = t.targetTouches[0].screenY) : (this.data.pagex.end = t.pageX, this.data.pagey.end = t.pageY), this.data.pos.end = E(this._el.drag), this.data.new_pos.x = -(this.data.pagex.start - this.data.pagex.end - this.data.pos.start.x), this.data.new_pos.y = -(this.data.pagey.start - this.data.pagey.end - this.data.pos.start.y), this.options.enable.x && (this._el.move.style.left = this.data.new_pos.x + "px"), this.options.enable.y && (this._el.move.style.top = this.data.new_pos.y + "px"), this.fire("dragmove", this.data)
        }
        _momentum() {
            var t = {
                    x: 0,
        ...
        Et = ht.extend({
            ...
            floor: function(t) {
                for (var e = new Date(this.data.date_obj.getTime()), i = 0; i < wt.length; i++)
                    if (wt[i][2](e), wt[i][0] == t) return new Et(e);
        ...
        formatBigYear(t, e) {
            ...
            if (n) {
                for (var r = 0; r < n.length; r++) {
                    var a = n[r];
                    if (Math.abs(i / a[0]) > 1) return It(Math.abs(i / a[0]), a[1])
                }
                return i.toString()
            }
            return z("Language file dateformats missing cosmological. Falling back."), It(i, e)
        }
        _(t) {
    ...
    var Ot = {
        en: {
            ...
            messages: {
                ...
                loading_timeline: "The COVID Timeline includes hundreds of data points, so please bear with us while it loads... ",
    ...
    class Jt {
        ...
        addEvent(t, e) {
            ...
            return void 0 === t.start_date ? (z("Missing start date, skipping event"), console.log(t), null) : (this._processDates(t), this._tidyFields(t), this.events.push(t), this.event_dict[i] = t, e || qt(this.events), i)
        }
        addEra(t) {
        ...
        getLatestDate() {
            ...
            return qt(t, "date"), t.slice(-1)[0].date
        }
        _tidyFields(t) {
            function e(t, e, i) {
                i || (i = ""), t.hasOwnProperty(e) || (t[e] = i)
            }
            t.group && (t.group = F(t.group)), t.text || (t.text = {}), e(t.text, "text"), e(t.text, "headline"), Yt(t, Vt, Zt), Yt(t, nt, Gt)
        }
    }
    async function Xt(t) {
        return new Promise((e, i) => {
            if (t.data) {
                var n = Kt(Qt(t.data, t), t);
            ...
            try {
                if (! function(t) {
                    ...
                    ! function(t, e) {
                        ...
                        if (Object.keys(e).includes("Start Date") || Object.keys(e).includes("End Date")) e["Start Date"] && (n.start_date = Lt(e["Start Date"])), e["End Date"] && (n.end_date = Lt(e["End Date"]));
                        else {
                            if (e.Year && (n.start_date = {
                                    ...
                                    year: te(e["End Year"]) || "",
                                    month: te(e["End Month"]) || "",
                                    day: te(e["End Day"]) || ""
                                }), e.Time) {
                                if (!n.start_date) throw new A("invalid_start_time_without_date");
                                N(n.start_date, Ht(e.Time))
                            }
                            if (e["End Time"]) {
                                if (!n.end_date) throw new A("invalid_end_time_without_date");
                                N(n.end_date, Ht(e["End Time"]))
                            }
                            if (n.start_date && !$t(n.start_date)) throw new A("invalid_date_err");
                            if (n.end_date && !$t(n.end_date)) throw new A("invalid_date_err")
                        }
                        return n
                    }(t), n)
                }
        ...
        if (ee(t)) {
            try {
                a = await async function(t, e) {
                    ...
                    var i = await ie(t, e.sheets_proxy);
                    if (i) return i
                }(t, n)
            } catch (t) {
                return r = new Jt, "NetworkError" == t.name ? r.logError(new A("network_err")) : "TLError" == t.name ? r.logError(t) : r.logError(new A("unknown_read_err", t.name)), void i(r)
            }
            if (r = new Jt(a), a.errors)
            ...
            error: function(t, e, n) {
                if (r = new Jt, "parsererror" == e) n = new A("invalid_url_err");
    ...
    oe("human", wt), oe("cosmological", At);
    const se = {
    ...
    class le {
        ...
        getDateFromTime(t) {
            if ("human" == this._scale) return new Et(t);
    ...
    class ue {
        constructor(t, e, i) {
            i && this.setLanguage(i), this._el = {
                ...
                width: 600,
                height: 600
            }, this.active = !1, this.animator = {}, this.axis_helper = {}, this.minor_ticks = [], this.major_ticks = [], this._el.container = "object" == typeof t ? t : T(t), N(this.options, e), this._initLayout(), this._initEvents()
        }
        show() {}
        hide() {}
        addTo(t) {
    ...
    class xe extends fe {
        _loadMedia() {
            ...
            this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe tl-media-soundcloud tl-media-shadow", this._el.content), this.media_id = this.data.url, t = "https://soundcloud.com/oembed?url=" + this.media_id + "&format=js&callback=?", vt(t, (function(t) {
                _e("https://w.soundcloud.com/player/api.js", (function() {
                    e.createMedia(t)
                }))
            }))
        }
    ...
    class Ee extends fe {
        ...
        createMedia(t) {
            var e, i, n, r = "",
                ...
                o = "",
                s = this;
            a = t.html.split("</p>&mdash;")[0] + "</p></blockquote>", e = t.author_url.split("twitter.com/")[1], i = (o = t.html.split("</p>&mdash;")[1].split('<a href="')[1]).split('">')[0], n = o.split('">')[1].split("</a>")[0], (a = a.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).includes("pic.twitter.com") ? (_e("https://platform.twitter.com/widgets.js", (function() {
    ...
    const Ae = "https://graph.facebook.com/v8.0/instagram_oembed?access_token=704270473831239|830b21071290df4f81a35c56abbea096&fields=html,thumbnail_url,author_name&url=";
    ...
    class Ne extends fe {
        ...
        getImageURL() {
            ...
            bt(`${Ae}${this.data.url}`).then(t => t.thumbnail_url).catch(t => {
    ...
    class Pe extends fe {
        _loadMedia() {
            try {
                ...
                _e(["https://s.imgur.com/min/embed.js"], (function() {
                    t.createMedia()
                }))
            } catch (t) {
        ...
        _initLayout() {
            if (this._el.container = M("div", "tl-timemarker"), this.data.unique_id && (this._el.container.id = this.data.unique_id + "-marker"), this.data.end_date && (this.has_end_date = !0, this._el.container.className = "tl-timemarker tl-timemarker-with-end"), this._el.timespan = M("div", "tl-timemarker-timespan", this._el.container), this._el.timespan_content = M("div", "tl-timemarker-timespan-content", this._el.timespan), this._el.content_container = M("div", "tl-timemarker-content-container", this._el.container), this._el.content = M("div", "tl-timemarker-content", this._el.content_container), this._el.line_left = M("div", "tl-timemarker-line-left", this._el.timespan), this._el.line_right = M("div", "tl-timemarker-line-right", this._el.timespan), this.data.media) {
                ...
                var t = {
                    ...
                    e = this.data.media.thumbnail ? Be(t, !0) : null;
                if (e) {
                    var i = new e.cls(t);
    ...
    class Ze {
        ...
        _getTimeScale() {
            ...
            return 0 == t && (z("marker_height_min option must not be zero."), t = 30), this.max_rows = Math.round((this.options.height - this._el.timeaxis_background.offsetHeight - this.options.marker_padding) / t), this.max_rows < 1 && (this.max_rows = 1), new le(this.config, {
        ...
        _createEras(t) {
            for (var e = 0; e < t.length; e++) {
                var i = t[e],
                    n = new ce(i.start_date, i.end_date, i.headline, this.options);
        ...
        _initLayout() {
            if (this._el.container = M("div", "tl-slide"), this.has.title && (this._el.container.className = "tl-slide tl-slide-titleslide"), this.data.unique_id && (this._el.container.id = this.data.unique_id), this._el.scroll_container = M("div", "tl-slide-scrollable-container", this._el.container), this._el.content_container = M("div", "tl-slide-content-container", this._el.scroll_container), this._el.content = M("div", "tl-slide-content", this._el.content_container), this._el.background = M("div", "tl-slide-background", this._el.container), this.data.background) {
                if (this.data.background.url) {
                    var t = Be(this.data.background, !0);
            ...
            this.data.media && this.data.media.url && "" != this.data.media.url && (this.has.media = !0), this.data.text && this.data.text.text && (this.has.text = !0), this.data.text && this.data.text.headline && (this.has.headline = !0), this.has.media && (this.data.media.mediatype = Be(this.data.media), this.options.media_name = this.data.media.mediatype.name, this.options.media_type = this.data.media.mediatype.type, this.options.autolink = this.data.autolink, this._media = new this.data.media.mediatype.cls(this.data.media, this.options, this.getLanguage())), (this.has.text || this.has.headline) && (this._text = new de(this.data.text, {
    ...
    class Ve {
        ...
        _createSlide(t, e, i) {
            var n = new Ge(t, this.options, e, this.getLanguage());
        ...
        _initLayout() {
            S(this._el.container, "tl-storyslider"), this._el.slider_container_mask = M("div", "tl-slider-container-mask", this._el.container), this._el.background = M("div", "tl-slider-background tl-animate", this._el.container), this._el.slider_container = M("div", "tl-slider-container tlanimate", this._el.slider_container_mask), this._el.slider_item_container = M("div", "tl-slider-item-container", this._el.slider_container), this.options.width = this._el.container.offsetWidth, this.options.height = this._el.container.offsetHeight, this._nav.previous = new Ye({
                ...
                direction: "previous"
            }), this._nav.next = new Ye({
                title: "Next",
                description: "description"
            }, {
                direction: "next"
            }), this._nav.next.addTo(this._el.container), this._nav.previous.addTo(this._el.container), this._el.slider_container.style.left = "0px", x && (this._swipable = new Ue(this._el.slider_container_mask, this._el.slider_container, {
                enable: {
                    x: !0,
                    y: !1
                },
    ...
    if (document) {
        ...
        t && t.length > 0 && (Xe = t[t.length - 1].src)
    }
    class Ke {
        constructor(t, e, i) {
            if (i || (i = {}), this.ready = !1, this._el = {
                    ...
                    timenav: {},
                    menubar: {}
                }, i.lang && !i.language && (i.language = i.lang), this.language = zt, this._storyslider = {}, this._timenav = {}, this._menubar = {}, this._loaded = {
                    storyslider: !1,
                    timenav: !1
            ...
            N(this.options, i), this.options.script_path || (this.options.script_path = this.determineScriptPath()), i.soundcite && this.on("ready", () => {
                z("Loading Soundcite resources "), me("https://cdn.knightlab.com/libs/soundcite/latest/css/player.css"), _e("https://cdn.knightlab.com/libs/soundcite/latest/js/soundcite.min.js")
        ...
        _loadStyles() {
            ...
            if (t && me(t), this.options.theme && (0 == this.options.theme.indexOf("http") || this.options.theme.match(/\.css$/))) e = this.options.theme;
